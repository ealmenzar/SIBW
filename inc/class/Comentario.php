        ...
        if ($this->isSet) {
            return "<div class='edit'>
                    <form method='post' action=''>
                        <input type=\"text\" name='autor' value='".$this->autor."'><br>
                        <input type=\"text\" name='email' value='".$this->email."'><br>
                        <textarea name='contenido'>".$this->contenido."</textarea><br>
                        <input type=\"submit\" value='Guardar'><br>
                    </form>
                    </div>";
        }
    }
    function showCommentLine(){
        if ($this->isSet) {
            return "<tr>
                        <td>".$this->id."</td>
                        <td>".$this->autor."</td>
                        <td>".$this->email."</td>
                        <td>".$this->fecha->format("d/m/Y")."</td>
                        <td>".$this->fecha->format("H:i")."</td>
                        <td>".$this->ip."</td>
                        <td>".$this->contenido."</td>
                        <td>".'<a style="display:inline-block" href="index.php?tpl=CommentAg&remove='.$this->id.'">
                            ...
                            <a style="display:inline-block" href="index.php?tpl=CommentAg&edit='.$this->id.'">
