...
if (isset($_GET["edit"])) {
    ...
    if(isset($_POST["titulo"],$_POST["anuncio"],$_POST["img"])) {
        ...
        echo"
            <div class='edit'>
            <form method='post' action=''>
                <input type=\"text\" name='titulo' value='".$arrayPubli['titulo']."'><br>
                <input type=\"text\" name='anuncio' value='".$arrayPubli['anuncio']."'><br>
                <input type='text' name='img' value='".$arrayPubli['img']."'><br>
                <input type=\"submit\" value='Guardar'><br>
            </form>
            </div>";
    }
